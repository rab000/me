...
////		Log.i ("RoleEditor","CreateAllRoleAB","step3---收集bundleBuild结束，开始打包",BeShowLog);
...
////
////		Log.i ("RoleEditor","CreateAllRoleAB","step4---生成角色AB结束,开始清理临时资源",BeShowLog);
////		//CleanTempAsset();
////
////		Log.i ("RoleEditor","CreateAllRoleAB","step5---清理临时资源完毕",BeShowLog);
////		AssetDatabase.Refresh();//因为输出文件夹位于Asset中，为了方便显示，刷新下
////
////		Log.i ("RoleEditor","CreateAllRoleAB","step6---刷新工程目录显示完毕，打包完成",BeShowLog);
////	}
////
////
////	/// <summary>
...
////		Log.i ("RoleEditor","GeneratePartMatAB","打包材质,材质数量:"+matURLs.Length,BeShowLog);
